...
define('APP_ROOT', 'AplikacjeInternetowe');
...
<html>
 ...
 <script src="/<?= APP_ROOT ?>/html/content/js/jquery-1.11.2.min.js"></script>
 </head>
 <body>
 <?php include 'html/includes/menu.php'; ?>
 <div class="container">
 <div class="row">
 <div class="col-md-12">Ksiegarnia internetowa</div>
 </div>
 <div class="row">
 <div class="col-md-12">
 ...
 <div class="row">
 <div class="col-md-12">
 Copyright &copy Ksiegarnia internetowa
 </div>
 </div>
 </div>
 <!--Dołączenie skrytpu javascript biblioteki bootstrap -->
 <script src="/<?= APP_ROOT ?>/html/content/js/bootstrap.min.js"></script>
 </body>
</html>
